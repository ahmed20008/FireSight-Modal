...
vidpath = os.path.expanduser('~/Desktop/fyp_yolov8/FireSight/videos/BoatfireIslandMarina.mp4') 
event_dir = os.path.expanduser('~/Desktop/fyp_yolov8/FireSight/detection_v8')

model_path=os.path.expanduser('~/Desktop/fyp_yolov8/FireSight/newmodelv8/newmodel4/train/weights/best.pt')
...
queue_5_seconds = deque(maxlen=90)  # 5 seconds at 30 fps
queue_15_seconds = deque(maxlen=460)  # 15 seconds at 30 fps
...
while capture.isOpened():
    ...
    if fire == True: #and frame_counter%2==0:
        queue_15_seconds.append(frame.copy())

        if len(queue_15_seconds) >= 360:  # 15 seconds
            # Save the 20-second queue as a video
            combined_frames = list(queue_5_seconds) + list(queue_15_seconds)
            ...
            fire = False
            queue_5_seconds.clear()
            queue_15_seconds.clear()

        #print(frame_counter)
    elif fire != True:# and frame_counter%2==0:
        queue_5_seconds.append(frame.copy())
